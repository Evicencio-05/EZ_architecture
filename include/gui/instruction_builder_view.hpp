...
public:
  ...
  void handleKeyPressed(
      int keyCode); // sf::Keyboard::Key as int to avoid header coupling
  ...
  [[nodiscard]] bool anyDropdownOpen() const {
    return m_opOpen || m_rsOpen || m_rtOpen || m_rdOpen;
  }
  [[nodiscard]] bool textActive() const { return m_immActive; }
  void openOp() {
    m_opOpen = true;
...
private:
  ...
  [[nodiscard]] std::string currentAssembly() const;
};
